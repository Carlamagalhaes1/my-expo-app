...
O **ClinicApp** é um aplicativo mobile moderno para gestão clínica,
permitindo acesso rápido a pacientes, agenda de consultas e visualização
de fichas detalhadas --- tudo com um design limpo e experiência fluida.
...
-   Tudo utilizando Zustand para estado global e NativeWind para
    estilização.
